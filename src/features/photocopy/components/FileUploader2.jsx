...
function FileUploader2({ className, label, children, isDisabled, ...props }) {
  ...
  return (
    <Styles className={className}>
      ...
      >
        <input {...getInputProps()} />
        <div className={`upload-button d-flex align-items-center justify-content-center px-3 py-2 btn btn-primary text-white`}>
