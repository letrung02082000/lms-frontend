...
function SearchOrder({ name, orderCode, category, document, receipt, state, isPrinted, instruction, isDelivered }) {
  return (
    <Styles>
      ...
      <div>
        ...
        {state === 3 && (
          <p>
            &#9193; Chờ xác nhận | &#9193; Đang xử lý và báo giá | &#9193; Đang in{' '}
            {isPrinted && <span>| &#9193; Đã in</span>} {isDelivered && <span>| &#9193; Đang giao hàng</span>}
          </p>
        )}
        {state === 4 && (
          <p>
            &#9193; Chờ xác nhận | &#9193; Đang xử lý và báo giá | &#9193; Đang in{' '}
            {isPrinted && <span>| &#9193; Đã in</span>} | &#9193; <b>Đã giao hàng</b>
          </p>
        )}
        {state === 5 && (
          <p>
