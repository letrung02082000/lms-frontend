      ...
      {order ? (
        ...
        <form style={props.display === false ? { display: 'none' } : null}>
          <ul style={{ listStyle: 'none', padding: '0' }}>
            <li>
              <strong>Giá vé: 600.000 đồng / 30 lượt / 2 tháng</strong>
            ...
            <li>
              ...
              <br />+ Ngân hàng: BIDV chi nhánh Đông Sài Gòn (Ngân hàng Thương mại cổ phần Đầu tư và Phát triển Việt
              Nam)
              <br />+ Số tài khoản: 31410002006579
              <br />+ Nội dung: Họ tên_SĐT_Ve Thang
              <br />+ Số tiền: 600.000 đồng
          ...
          {isLoading ? (
            ...
            <button type="button" onClick={handleTicketSubmitButton} className={styles.formSubmitButton}>
              Đăng ký
            </button>
          )}
          <p style={{ margin: '1rem 0' }}>
