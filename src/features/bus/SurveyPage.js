...
import { selectUser, updateEmail, updateName, updateTel } from 'store/userSlice'
...
export function BusSurveyPage() {
  ...
  const getSuggestions = value => {
    ...
    let filterList = schoolList.filter(suggestion => suggestion.toLowerCase().indexOf(inputValue.toLowerCase()) > -1)
  ...
  return (
    <div className={styles.drivingRegisterContainer}>
      ...
      <form className={styles.drivingFormContainer}>
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Địa chỉ email (không bắt buộc)</label>
          <input
            className={styles.formInput}
            id="formEmail"
            type="text"
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>
            Bạn có mong muốn được sử dụng dịch vụ xe đưa đón từ nhà đến trường và ngược lại không (dịch vụ Shuttle Bus:
            Chọn chỗ và thanh toán online; Biết vị trí xe bus; Không căng thẳng khi phải tự điều khiển xe; An toàn, bảo
            vệ môi trường...)?*
          </label>
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Đâu là lý do quan trọng nhất khi bạn chọn dịch vụ xe đưa đón này*</label>
          <div className={styles.selectContainer}>
            <input
              className={styles.formInput}
              type="radio"
          ...
          <div className={styles.selectContainer}>
            ...
            />
            <p onClick={() => handleReasonChange(1)}>Không muốn tự điều khiển xe cá nhân</p>
          </div>
          <div className={styles.selectContainer}>
            <input
              className={styles.formInput}
            ...
            />
            <p onClick={() => handleReasonChange(2)}>Khoảng cách từ nhà đến trường quá xa</p>
          </div>
          <div className={styles.selectContainer}>
            <input
              className={styles.formInput}
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel} style={{ color: 'red' }}>
            Chọn lần lượt <strong>giờ đến trường (giờ có mặt tại trường dự kiến)</strong> và <strong>giờ về</strong> cho
            các ngày từ Thứ Hai đến Chủ Nhật (có thể bỏ trống các ngày không có nhu cầu)
          </label>
          <div>
            <button
              className={currentDay === 0 ? styles.selectedDay : styles.dayOfWeek}
              onClick={e => handleDayChange(e, 0)}
            >
              Thứ 2
            </button>
            <button
              className={currentDay === 1 ? styles.selectedDay : styles.dayOfWeek}
              onClick={e => handleDayChange(e, 1)}
            >
              Thứ 3
            </button>
            <button
              className={currentDay === 2 ? styles.selectedDay : styles.dayOfWeek}
              onClick={e => handleDayChange(e, 2)}
            >
              Thứ 4
            </button>
            <button
              className={currentDay === 3 ? styles.selectedDay : styles.dayOfWeek}
              onClick={e => handleDayChange(e, 3)}
            >
              Thứ 5
            </button>
            <button
              className={currentDay === 4 ? styles.selectedDay : styles.dayOfWeek}
              onClick={e => handleDayChange(e, 4)}
            >
              Thứ 6
            </button>
            <button
              className={currentDay === 5 ? styles.selectedDay : styles.dayOfWeek}
              onClick={e => handleDayChange(e, 5)}
            >
              Thứ 7
            </button>
            <button
              className={currentDay === 6 ? styles.selectedDay : styles.dayOfWeek}
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Giờ về ({currentDayText}) *</label>
          <div className={styles.inTimeContainer}>
            <div className={styles.boxGroup}>
              <input
                type="checkbox"
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Địa chỉ đón bạn (chỉ nhập số nhà và đường hoặc KTX đang ở)*</label>
          <input
            className={styles.formInput}
            id="formAddress"
            type="text"
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Vui lòng chọn trường bạn muốn đến*</label>
          {/* <input
            className={styles.formInput}
            id='formSchool'
            type='text'
