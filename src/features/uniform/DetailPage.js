...
export default function DetailPage(props) {
  ...
  const handleSubmitButton = () => {
    ...
    axios
      ...
      .then(res => {
        setIsLoading(false)
        alert('Bạn đã đặt hàng thành công! Chúng tôi sẽ liên hệ với bạn trong thời gian 1 ngày')
      })
      .catch(err => {
        alert('Lỗi: ' + err.toString() + '. Liên hệ admin tại zalo: 0797324886 để được hỗ trợ nhanh nhất. Xin cảm ơn!')
        setIsLoading(false)
      })
  }
