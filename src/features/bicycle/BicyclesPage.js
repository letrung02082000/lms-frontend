      ...
      >
        ...
        >
          ...
          * Hướng dẫn khắc phục lỗi:
          <br />- Không cập nhật được giấy tờ tùy thân (Lỗi 401): vui lòng đăng
          xuất tài khoản và đăng nhập lại để khắc phục.
          <br />- Không mở được camera: Cấp quyền camera cho ứng dụng trên trình
          duyệt đang sử dụng hoặc tải trình duyệt Firefox về từ CH Play/App
          Store để truy cập vào website.
