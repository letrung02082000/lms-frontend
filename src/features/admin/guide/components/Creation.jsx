    ...
    <div className={styles.container}>
      <form onSubmit={onSubmit}>
        <div className={styles.formGroup}>
          ...
          <input className={styles.formInput} id="formPriority" placeholder="Nhập số lớn hơn 0" />
        </div>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Tiêu đề</label>
          <input className={styles.formInput} id="formTitle" placeholder="Nhập tiêu đề bài viết" />
        </div>
        ...
        <input className={styles.submitButton} type="submit" value={'Tạo bài viết'} />
      </form>
    </div>
  )
}
