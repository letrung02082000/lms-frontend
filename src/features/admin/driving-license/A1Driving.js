    ...
    <div>
        ...
        {dates.map((child, index) => {
          return (
            <button
              ...
              key={child._id}
              style={dateSelected === index ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
            >
      ...
      <div className={styles.stateButtonContainer}>
        <button
          ...
          className={styles.dateButton}
          style={state == null ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
        >
          Tất cả
        </button>
        ...
        <button
          ...
          className={styles.dateButton}
          style={state === 0 ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
        >
          Đã tạo
        </button>
        <button
          ...
          className={styles.dateButton}
          style={state === 1 ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
        >
          Chờ cập nhật
        </button>
        <button
          ...
          className={styles.dateButton}
          style={state === 2 ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
        >
          Chờ thanh toán
        </button>
        <button
          ...
          className={styles.dateButton}
          style={state === 3 ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
        >
          Đã hoàn tất
        </button>
        <button
          ...
          className={styles.dateButton}
          style={state === 4 ? { backgroundColor: 'var(--primary)', color: 'white' } : null}
        >
          Đã hủy
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div>
          {data.map(child => {
            return <Driving info={child} dateList={dates} key={child._id} id={child._id} showImage={showImage} />
          })}
        </div>
      )}
    </div>
